...
const factory = create().properties<{ config: any, open: boolean, onMenuToggle: (open: boolean) => void }>();
				...
				<div classes="flex items-center -mx-6">
					...
					<div class="flex flex-grow lg:w-3/4 xl:w-4/5">
						...
						<button type="button" onclick={ () => {
							onMenuToggle(!open);
						} } class={`${open ? 'hidden' : '' } flex px-6 items-center lg:hidden text-gray-500 focus:outline-none focus:text-gray-700`}>
