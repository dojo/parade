...
export default factory(function MainMenu({ properties }) {
	...
	return (
		<div
			classes={`${
				showMenu ? '' : 'hidden'
			} fixed inset-0 pt-16 h-full bg-white z-90 w-full border-b -mb-16 lg:-mb-0 lg:static lg:h-auto lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5`}
		>
